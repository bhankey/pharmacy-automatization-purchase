...
type PurchaseServiceClient interface {
	...
	BuyReservation(ctx context.Context, in *GetReservationRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *purchaseServiceClient) BuyReservation(ctx context.Context, in *GetReservationRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type PurchaseServiceServer interface {
	...
	BuyReservation(context.Context, *GetReservationRequest) (*emptypb.Empty, error)
...
func (UnimplementedPurchaseServiceServer) BuyReservation(context.Context, *GetReservationRequest) (*emptypb.Empty, error) {
...
func _PurchaseService_BuyReservation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PurchaseServiceServer).BuyReservation(ctx, req.(*GetReservationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
